      ...
      <div className="about-me__container">
        ...
        <div className="about-me__info">
          ...
          <p className="about-me__text">
            Я живу в Санкт-Петербурге. Студент ИТМО. С 2021 по 2023 работал в
            компании по разработке коммерческих проектов. Создал платформу по
            обучению студентов береговой охраны для МО РФ, платформу для повышения финансовой грамотности Кузбасса.
          </p>
          <a
